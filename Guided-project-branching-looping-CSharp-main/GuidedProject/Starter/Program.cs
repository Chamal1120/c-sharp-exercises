    ...
    switch (menuSelection) {
      ...
      case "2":
        ...
        while (anotherPet == "y" && petCount < maxPets) {
          ...
          // Build the animal ID number (C1, C2, C3 , ... for Cat1, Cat2, Cat3 ...)
      ...
      case "3":
        ...
        break;
      case "4":
        // Edit an animal's nickname and personality descriptions are complete
        Console.WriteLine(
            "Challenge Project - please check back soon to see progress.");
        Console.WriteLine("Press the Enter key to continue.");
        readResult = Console.ReadLine();
      ...
      case "5":
        ...
        break;
      case "6":
        // Edit an animal's age personality description
        Console.WriteLine(
            "UNDER CONSTRUCTION - please check back next month to see progress.");
        Console.WriteLine("Press the Enter key to continue.");
        readResult = Console.ReadLine();
